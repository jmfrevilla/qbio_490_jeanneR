...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/mi/Desktop/QBIO/qbio_490_jeanneR")) 
```
...
my_var <- "HI R STUDIO I LIKE HALF ALIVE'S NEW SONG SUBLIMINAL"
...
age <- 19
birthday <- "06/20/2004"
three_fav_colors <- c("pink","blue","green")
...
```{r Exercise 9.4}
# write code here
mtcars_copy <- mtcars[1:32, c(1:8, 10,11,12)]
```
